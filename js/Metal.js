...
const evm = cubeTextureLoader.load([
    "../image_fondo/fondo-metálico.jpg",
    "../image_fondo/fondo-metálico-copia.jpg",
    "../image_fondo/fondo-metálico-copia(2).jpg",
    "../image_fondo/fondo-metálico-copia(3).jpg",
]);
...
const geometry = new THREE.TorusGeometry(5, 15, 40, 3);
