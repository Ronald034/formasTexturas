...
loader.load('../image_fondo/space.jpg', function(texture){
...
const geometry = new THREE.TorusKnotGeometry( 0.5, 12, 50, 12,);
const geometry2 = new THREE.TorusKnotGeometry( 0.5, 12, 50, 12,);
const geometry3 = new THREE.TorusKnotGeometry( 0.5, 12, 50, 12,);
const geometry4 = new THREE.TorusKnotGeometry( 0.5, 12, 50, 12,);
