...
const matcap = textura.load("..images_texture/summer-background-of-sea-water.jpg")

var loader = new THREE.TextureLoader();
loader.load('../image_fondo/tecno-ciudad.jpg', function(texture){
...
const geometry = new THREE.RingGeometry(0.5, 1, 12)
